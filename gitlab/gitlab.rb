...
external_url 'http://gitlab.commutiva.pl/'
...
gitlab_rails['smtp_user_name'] = "gitlab@intellikode.com"
gitlab_rails['smtp_password'] = "jVB4gUKeZKqh2w"
gitlab_rails['smtp_domain'] = "intellikode.com"
...
# ci_external_url 'http://ci.commutiva.pl'
...
# gitlab_ci['gitlab_server'] = { "url" => 'http://gitlab.commutiva.pl', "app_id" => '12345678', "app_secret" => 'QWERTY12345' }

# gitlab_ci['gitlab_ci_email_from'] = 'gitlab-ci@commutiva.pl'
# gitlab_ci['gitlab_ci_support_email'] = 'gitlab-ci@commutiva.pl'
...
# gitlab_ci['smtp_domain'] = "commutiva.pl"
